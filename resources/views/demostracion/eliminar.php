...
?>
   ...
   <div class="modal" id="empleado_eliminar<?php echo $mostrar['id']?>" tabindex="-1">
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="nombre_completo_elim" value="<?php echo $mostrar['nombre_completo']?>" name="nombre_completo_elim" placeholder="Jose Lopez" readonly><br>
      <div class="valid-feedback">  
      </div>
      </div>
      <br>
